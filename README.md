...
[![Build Status](https://travis-ci.org/aimeoscom/gs-saferpay.svg?branch=master)](https://travis-ci.org/aimeoscom/gs-saferpay)
[![Coverage Status](https://coveralls.io/repos/aimeoscom/gs-saferpay/badge.svg?branch=master&service=github)](https://coveralls.io/github/aimeos/gs-saferpay?branch=master)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/aimeoscom/gs-saferpay/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/aimeos/gs-saferpay/?branch=master)
[![License](https://poser.pugx.org/aimeos/gs-saferpay/license.svg)](https://packagist.org/packages/aimeoscom/gs-saferpay)

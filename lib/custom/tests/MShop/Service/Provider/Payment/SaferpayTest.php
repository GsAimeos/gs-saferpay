...
class SaferpayTest extends \PHPUnit\Framework\TestCase
{
    private $object;
    private $context;
    private $serviceItem;
    ...
    protected function setUp()
    {
        ...
        $this->serviceItem->setConfig([ 'omnipay.type' => 'Dummy' ]);
    ...
    public function testProcessOffsitePurchaseSuccess()
    {
        ...
        $this->serviceItem->setConfig([ 'omnipay.type' => 'Dummy', 'omnipay.address' => '1' ]);
    ...
    public function testProcessOffsiteAuthorizeSuccess()
    {
        ...
        $this->serviceItem->setConfig([ 'omnipay.type' => 'Dummy', 'omnipay.authorize' => '1', 'omnipay.onsite' => 1 ]);
    ...
    public function testProcessOffsiteAuthorizeFailure()
    {
        ...
        $this->serviceItem->setConfig([ 'omnipay.type' => 'Dummy', 'omnipay.authorize' => '1' ]);
    ...
    public function testProcessOffsiteRedirect()
    {
        ...
        $response = $this->getMockBuilder('Aimeos\MShop\Service\Provider\Payment\ResponseRedirectTest')
            ->setMethods([ 'getTransactionReference' ])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testUpdateSyncNone()
    {
        ...
        $provider = $this->getMockBuilder('Omnipay\Dummy\Gateway')
            ->setMethods([ 'supportsCompletePurchase', 'completePurchase' ])
            ->getMock();
    ...
    public function testUpdatePushSuccess()
    {
        ...
        $provider = $this->getMockBuilder('Omnipay\Dummy\Gateway')
            ->setMethods([ 'supportsAcceptNotification', 'acceptNotification', 'saveOrder' ])
            ->getMock();

        $request = $this->getMockBuilder('\Omnipay\Dummy\Message\AuthorizeRequest')
            ->disableOriginalConstructor()
            ->setMethods([ 'getTransactionStatus', 'send' ])
            ->getMock();
    ...
    public function testUpdatePushCancelled()
    {
        ...
        $provider = $this->getMockBuilder('Omnipay\Dummy\Gateway')
            ->setMethods([ 'supportsAcceptNotification', 'acceptNotification' ])
            ->getMock();
    ...
    public function testUpdateSyncAuthorizeFailed()
    {
        ...
        $provider = $this->getMockBuilder('Omnipay\Dummy\Gateway')
            ->setMethods([ 'supportsCompleteAuthorize', 'completeAuthorize' ])
            ->getMock();
    ...
    public function testUpdateSyncRedirect()
    {
        ...
        $response = $this->getMockBuilder('Aimeos\MShop\Service\Provider\Payment\ResponseRedirectTest')
            ->setMethods([ 'getTransactionReference', 'isRedirect' ])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testCapture()
    {
        ...
        $provider = $this->getMockBuilder('Omnipay\Dummy\Gateway')
            ->setMethods([ 'supportsCapture', 'capture' ])
            ->getMock();
    ...
    public function testRefund()
    {
        ...
        $provider = $this->getMockBuilder('Omnipay\Dummy\Gateway')
            ->setMethods([ 'supportsRefund', 'refund' ])
            ->getMock();
...
if (class_exists('Omnipay\Dummy\Message\Response')
    ...
    class ResponseRedirectTest extends \Omnipay\Dummy\Message\Response implements \Omnipay\Common\Message\RedirectResponseInterface
    {
